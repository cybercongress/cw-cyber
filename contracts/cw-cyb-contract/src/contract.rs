...
pub fn execute(
    ...
    match msg {
        ExecuteMsg::NewEntry {
            ...
            execute_hash,
            reproduce_info,
        } => execute_create_new_item(deps, info,address,query_hash,execute_hash,reproduce_info),
        ExecuteMsg::UpdateEntry {
            ...
            execute_hash,
            reproduce_info,
        } => execute_update_item(deps, info, id, address, query_hash, execute_hash, reproduce_info),
