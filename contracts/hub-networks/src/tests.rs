...
mod tests {
    ...
    fn create_update_delete_entry() {
        ...
        let msg = ExecuteMsg::CreateEntry {
            ...
            genesis_hash: "QmTR1k469ZNJdmhT2WY67A6fccpj1pRkHTmnZZtYpPDnH7".to_string(),
            unbonding_period: "42".to_string(),
            logo: "QmaFs8AjTfNy6XFq8xb6boN1eC4nrznaPnvytJtq3FHnkf".to_string(),
        ...
        let msg = ExecuteMsg::CreateEntry {
            ...
            prefix: "cyb".to_string(),
            genesis_hash: "QmYubyVNfghD4xCrTFj26zBwrF9s5GJhi1TmxvrwmJCipr".to_string(),
            unbonding_period: "42".to_string(),
            logo: "QmaFs8AjTfNy6XFq8xb6boN1eC4nrznaPnvytJtq3FHnkf".to_string(),
            particle: Some("QmYpTB36duejmy1szbdL1D2EzC5fgRL4dyhSFsHkMYPtny".to_string()), 
        };
        ...
        let message = ExecuteMsg::UpdateEntry {
            ...
            genesis_hash: Some("QmYpTB36duejmy1szbdL1D2EzC5fgRL4dyhSFsHkMYPtny".to_string()),
            unbonding_period: Some("42".to_string()),
            logo: Some("QmaFs8AjTfNy6XFq8xb6boN1eC4nrznaPnvytJtq3FHnkf".to_string()),
            particle: Some("QmYpTB36duejmy1szbdL1D2EzC5fgRL4dyhSFsHkMYPtny".to_string()), 
        };
        ...
        assert_eq!(
            Vec::from([
                Entry {
                    ...
                    chain_id: "cyber-1".to_string(),
                    prefix: "cyb".to_string(),
                    genesis_hash: "QmYpTB36duejmy1szbdL1D2EzC5fgRL4dyhSFsHkMYPtny".to_string(),
                    unbonding_period: "42".to_string(),
                    logo: "QmaFs8AjTfNy6XFq8xb6boN1eC4nrznaPnvytJtq3FHnkf".to_string(),
                    particle: "QmYpTB36duejmy1szbdL1D2EzC5fgRL4dyhSFsHkMYPtny".to_string(), 
                },
