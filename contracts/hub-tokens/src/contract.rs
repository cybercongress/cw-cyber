...
pub fn execute(
    ...
    match msg {
        ...
        ExecuteMsg::CreateEntry {
            ...
            logo,
            particle,
        } => execute_create_entry(deps, info, ticker, chain_id, contract, decimals, channel_id, logo, particle),
        ExecuteMsg::UpdateEntry {
            ...
            logo,
            particle,
        } => execute_update_entry(deps, info, id, ticker, chain_id, contract, decimals, channel_id, logo, particle),
